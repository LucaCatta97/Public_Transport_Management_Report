...
\puttitle{
	title=  Project of the public transport service for the new Business Park in Stradella, % Title of the thesis
	name=\\ 
	      \vspace{0.2 cm}\\
...
\input{chapters/Demand_Offer_Analysis}
\input{chapters/Sizing_and_scheduling}
\input{chapters/financial_part}
